% lane_length: 要画的车道线的长度
function [ CC_rgb ] = fun_plot_lane( lane_coeff, lane_length, CC_rgb, rgb_value_t, camera_parameter  )
...
%     x_max = min(x_max, 10);
    ...
    for x_line = x_min:0.1:x_max
        ...
        if x_line<lane_length && x_line>x_min && y_line>y_min && y_line<y_max  
